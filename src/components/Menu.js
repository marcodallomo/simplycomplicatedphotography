  ...
  return (
    <Navbar collapseOnSelect expand="lg" variant="dark" fixed="top" expanded={expanded}>
      <Container style={{ backgroundColor: "#292b2c", display: "flex", justifyContent: "space-between" }}>
        ...
        <Navbar.Toggle style={{ fontSize: "17px", color: "lightblue", border: "none", marginRight: "10px" }} aria-controls="responsive-navbar-nav" onClick={() => setExpanded(expanded ? false : "expanded")}>
